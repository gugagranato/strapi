...
export interface ApiAssinaturaAssinatura extends Schema.CollectionType {
...
export interface ApiAulaAula extends Schema.CollectionType {
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::aula.aula', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::aula.aula', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiClienteCliente extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    assinaturas: Attribute.Relation<
      'api::cliente.cliente',
      'oneToMany',
      'api::assinatura.assinatura'
    >;
    email: Attribute.Email;
    status: Attribute.Boolean;
    temperament: Attribute.Enumeration<['F', 'C', 'S', 'M', 'N']>;
    password: Attribute.Password;
    is: Attribute.UID;
...
export interface ApiCursoCurso extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    description: Attribute.Text;
    folder: Attribute.Media;
    categorias: Attribute.Relation<
      'api::curso.curso',
      'manyToMany',
      'api::categoria.categoria'
    >;
    modulos: Attribute.Relation<
      'api::curso.curso',
      'oneToMany',
      'api::modulo.modulo'
    >;
    ...
    material_curso: Attribute.Relation<
      'api::curso.curso',
      'manyToOne',
      'api::material.material'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::assinatura.assinatura': ApiAssinaturaAssinatura;
